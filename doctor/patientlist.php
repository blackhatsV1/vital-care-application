...
if (!isset($_SESSION['doctorSession'])) {
    ...
    exit(); // Add an exit here to stop executing the script further
}
...
// Check if $userRow is not null and contains expected keys
if (!empty($userRow) && isset($userRow['doctorFirstName']) && isset($userRow['doctorLastName'])) {
    $title = "Welcome Dr " . $userRow['doctorFirstName'] . ' ' . $userRow['doctorLastName'];
} else {
    // Handle the case where $userRow is null or missing expected keys
