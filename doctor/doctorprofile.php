...
if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE doctor SET doctorFirstName='$doctorFirstName', doctorLastName='$doctorLastName', doctorPhone='$doctorPhone', doctorEmail='$doctorEmail', doctorAddress='$doctorAddress' WHERE doctorId=".$_SESSION['doctorSession'];
    ...
    if ($_FILES["profileImage"]["error"] == UPLOAD_ERR_OK) {
        ...
        if ($uploadOk) {
            ...
            $updateQuery = "UPDATE doctor SET profileImage='$targetFile' WHERE doctorId=".$_SESSION['doctorSession'];
            mysqli_query($con, $updateQuery);
...
$result = mysqli_query($con, "SELECT profileImage FROM doctor WHERE doctorId = ".$_SESSION['doctorSession']);
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Profile info</h4>
                                    </div>
