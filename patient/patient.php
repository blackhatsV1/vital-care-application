		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="../assets/img/bgcare.png" height="40px"></a>
				</div>
				...
				<div class="row">
					<div class="col-xs-12 col-md-8">
						...
						echo "<div class='row'>";
							...
							?>
							<!-- notification end -->
							<h2>Hi <?php echo $userRow['patientFirstName']; ?> <?php echo $userRow['patientLastName']; ?>.</h2>
							<h2>Make appointment today!</h2><br/>
